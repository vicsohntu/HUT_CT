...
from vit_pytorch.tnt import USSLNet
...
for epoch in range(epochs):
    ...
    if epoch%5==0:
        with torch.no_grad():
            mean_dice, mean_hd95, mean_iou, mean_precision, mean_recall, std_dice, std_hd95, std_iou, std_precision, std_recall=metric_eval_fcnn_isles2018(model, tstloader, norm=False, device=device, num_classes=num_classes)
